...
if 'iconvqa' in args.dataset:
    ...
    #         if str(answer_ranks[idx][0])  in str(answer):
    #             count += 1
    #         elif str(answer) in str(answer_ranks[idx][0]) :
    #             count += 1
    #         elif str(answer_ranks[idx][0]) == str(answer):
    #             count += 1
...
if 'vsr' in args.dataset:
    eval_file_path = cfg.evaluation_datasets_cfg["vsr"]["eval_file_path"]
    ...
    annotation = load_dataset(eval_file_path, split='test')
